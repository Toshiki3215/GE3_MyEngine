...
public:
	...
	void SetTextureCommandsPost(uint32_t index, ComPtr<ID3D12DescriptorHeap> descHeapSRV, ComPtr <ID3D12PipelineState> _pipelineState, ComPtr<ID3D12RootSignature> rootSignature);
